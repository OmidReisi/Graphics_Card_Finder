...
url = rf"https://www.newegg.com/p/pl?d={gpu_name}&N=4131"
...
for page in range(number_of_pages):
    url = rf"https://www.newegg.com/p/pl?d={gpu_name}&N=4131&page={page+1}"
...
with open(rf"./{gpu_name}.csv", mode="w", encoding="utf8", newline="") as file:
